...
Begin VB.Form MainSmall 
   ...
   End
End
Attribute VB_Name = "MainSmall"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
'¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯'
' This Form Loads Up if the Display is 800x600 '
'______________________________________________'

'¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯'
' There is info on what each GENERAL sub does above it '
...
Private Sub InfoArea_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
 ' move paddles even if the mouse leaves the "Area" Picturebox
...
'¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯'
' Reset All Variables and reture to start screen'                          '
...
Public Sub SavePlanet()
 ...
 WAVLoop "Shoot.qbs"
 Ball.Visible = True
 ' draw red lines from the screen corner to the ball
 ...
 ' display text and set next mssions
 Case 2
 ...
 XSpeed = CmdSpeedParam
 YSpeed = CmdSpeedParam
 ' make sure the bouncing has stoped
 ExitBounce = False
 ' double check the bouncing has stoped ( some errors may reinstate the initial value)
 ExitBounce = False
 Bounce
End Sub
...
Private Sub Area_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
 ...
 LPad.Top = RPad.Top
End Sub
' Loads All Things and sets variables to defaults
Sub Form_Load()
 Load LoadUp
 LoadUp.Visible = True
 ExitBounce = True
...
Private Sub LoadGamePics()
 ...
 GamePicsLoaded = True
End Sub
' Loads the title screen pictures
...
End Sub
'¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯'
' This Is The Most Important Sub.    '
' It Tells The Ball How To Bounce,   '
' To Increase In Speed, To Add To    '
' The Score And To Test If The Ball  '
' Has Been Missed By The Player      '
...
' Called When The Player Missed The Ball
Public Sub Die()
 ExitBounce = True
 ' deduct a life
 LivesLeft = LivesLeft - 1
...
'centre earth
 ...
 BlowUpEarth.Animate 0, 0, 0
 BlowUpEarth.Visible = True
 
 KillEarth.ZOrder 0
 BlowUpEarth.ZOrder 0
