...
Begin VB.Form TrainFrm 
   BorderStyle     =   0  'None
   Caption         =   "QuadBallTraining"
   ClientHeight    =   9930
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   12855
   ...
   Begin VB.PictureBox Area 
      ...
      Height          =   9030
      Left            =   0
      MouseIcon       =   "TrainSmallFrm.frx":09BA
...
'¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯'
' This Ub Loads up Top Scores From The Registry '
...
Private Sub Area_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
 ' This Controls Where The Paddles GO
...
'¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯'
' Load All The Title Screen Pictures  '
...
GetSpeed
If ExitBounce = True Then GoTo Nd2: ' See if the game has started
Ball.Visible = True
' Set The Ball To it's Round Shape
...
If Bounces = 15 Then
 ...
 'AUTO
 '-----------------
 'TPad.Left = Ball.Left - (TPad.Width / 2)
 'BPad.Left = TPad.Left
 'LPad.Top = Ball.Top - (LPad.Height / 2)
 'RPad.Top = LPad.Top
End If
Bounces = Bounces + 1
...
'¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯'
'This Is Activated When The Player Misses The Ball '
...
' decrease the lives
 ...
 'See which planet has been destroyed
 ...
 ExitBounce = False
 TimeSoFar = "00:00:00"
 Bounce ' start bouncing if earth is not dead
End Sub

'¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯'
' Animate the ball dissolving '
'_____________________________'
...
'¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯'
' Sub Which Adds The Total Score Up '
...
'¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯'
' Sub Which Gets The Current Speed Of The Ball'
